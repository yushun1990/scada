...
import { Arc, Ellipse, Group, Layer, Line, Rect, RegularPolygon, Stage, Transformer } from 'react-konva'
import {
...
import { ComponentCanvasToolbars } from './ComponentCanvasToolbar'
import {
...
} from './ComponentLineInteractionOverlay'
import {
...
export function ComponentVisualCanvas({
  ...
  return (
    <>
      <ComponentCanvasToolbars
        editToolbarHost={editToolbarHost}
