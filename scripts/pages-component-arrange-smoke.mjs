...
try {
  ...
  assert.equal(await rowButton('文本 1', '置于顶层').isEnabled(), true)
  assert.equal(await rowButton('文本 1', '置于底层').isDisabled(), true)
  await rowButton('文本 1', '置于顶层').click()
  ...
  await rowButton('文本 1', '置于底层').click()
